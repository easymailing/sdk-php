...
final class AutomationStep_AutomationStepTriggerAutomation_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?TriggerAutomationAction_jsonld_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? TriggerAutomationAction_jsonld_automation_step_write::fromArray($data['action']) : null,
