...
final class AutomationStep_AutomationStepUnsubscribeResource_automation_step_read
{
    public function __construct(
        public readonly ?UnsubscribeAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? UnsubscribeAction_automation_step_read::fromArray($data['action']) : null,
