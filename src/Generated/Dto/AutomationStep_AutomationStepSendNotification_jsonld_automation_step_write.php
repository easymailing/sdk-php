...
final class AutomationStep_AutomationStepSendNotification_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?SendNotificationAction_jsonld_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendNotificationAction_jsonld_automation_step_write::fromArray($data['action']) : null,
