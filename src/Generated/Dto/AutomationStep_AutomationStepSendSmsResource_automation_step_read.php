...
final class AutomationStep_AutomationStepSendSmsResource_automation_step_read
{
    public function __construct(
        public readonly ?SendSmsAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendSmsAction_automation_step_read::fromArray($data['action']) : null,
