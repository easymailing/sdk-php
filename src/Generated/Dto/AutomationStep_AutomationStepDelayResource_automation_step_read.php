...
final class AutomationStep_AutomationStepDelayResource_automation_step_read
{
    public function __construct(
        public readonly ?DelayAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? DelayAction_automation_step_read::fromArray($data['action']) : null,
