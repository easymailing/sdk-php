...
final class AutomationStep_AutomationStepRemoveFromGroup_automation_step_write
{
    public function __construct(
        public readonly ?RemoveFromGroupAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? RemoveFromGroupAction_automation_step_write::fromArray($data['action']) : null,
