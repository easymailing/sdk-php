...
final class AutomationStep_AutomationStepConditionResource_automation_step_read
{
    public function __construct(
        public readonly ?ConditionAction_automation_step_read $action = null,
        public readonly ?string $automation = null,
        public readonly ?AutomationStepChildrenCondition_automation_step_read $children = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? ConditionAction_automation_step_read::fromArray($data['action']) : null,
            automation: $data['automation'] ?? null,
            children: isset($data['children']) ? AutomationStepChildrenCondition_automation_step_read::fromArray($data['children']) : null,
