...
final class Automation_automation_read
{
    public function __construct(
        public readonly ?string $audience = null,
        /** @var list<AutomationTrigger_automation_read>|null */
        ...
        public readonly ?AutomationMetric_automation_read $stats = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            automation_triggers: isset($data['automation_triggers']) ? array_map(fn($x) => AutomationTrigger_automation_read::fromArray($x), $data['automation_triggers']) : null,
            ...
            stats: isset($data['stats']) ? AutomationMetric_automation_read::fromArray($data['stats']) : null,
