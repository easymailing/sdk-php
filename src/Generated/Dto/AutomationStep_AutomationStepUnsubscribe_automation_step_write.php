...
final class AutomationStep_AutomationStepUnsubscribe_automation_step_write
{
    public function __construct(
        public readonly ?UnsubscribeAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? UnsubscribeAction_automation_step_write::fromArray($data['action']) : null,
