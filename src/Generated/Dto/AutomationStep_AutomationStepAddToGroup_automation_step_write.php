...
final class AutomationStep_AutomationStepAddToGroup_automation_step_write
{
    public function __construct(
        public readonly ?AddToGroupAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? AddToGroupAction_automation_step_write::fromArray($data['action']) : null,
