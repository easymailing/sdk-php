...
final class DesignSetting_design_setting_create
{
    public function __construct(
        public readonly string $title,
        public readonly ?ButtonDto_design_setting_create $button = null,
        /** @var list<array<string,mixed>>|null */
        public readonly ?array $color_palette = null,
        /** @var list<CustomFontDto_design_setting_create>|null */
        ...
        /** @var list<SocialLinkDto_design_setting_create>|null */
        public readonly ?array $social_links = null,
        public readonly ?TextsDto_design_setting_create $texts = null,
        public readonly ?TitlesDto_design_setting_create $titles = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            title: $data['title'],
            button: isset($data['button']) ? ButtonDto_design_setting_create::fromArray($data['button']) : null,
            color_palette: $data['color_palette'] ?? null,
            custom_fonts: isset($data['custom_fonts']) ? array_map(fn($x) => CustomFontDto_design_setting_create::fromArray($x), $data['custom_fonts']) : null,
            default: $data['default'] ?? null,
            email_width: $data['email_width'] ?? null,
            page_width: $data['page_width'] ?? null,
            social_links: isset($data['social_links']) ? array_map(fn($x) => SocialLinkDto_design_setting_create::fromArray($x), $data['social_links']) : null,
            texts: isset($data['texts']) ? TextsDto_design_setting_create::fromArray($data['texts']) : null,
            titles: isset($data['titles']) ? TitlesDto_design_setting_create::fromArray($data['titles']) : null,
        );
    }
