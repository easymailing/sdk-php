...
final class AutomationStep_AutomationStepMoveToStepResource_jsonld_automation_step_read
{
    public function __construct(
        ...
        public readonly ?MoveToStepAction_jsonld_automation_step_read $action = null,
        ...
        public readonly ?string $target_step_label = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            action: isset($data['action']) ? MoveToStepAction_jsonld_automation_step_read::fromArray($data['action']) : null,
            ...
            target_step_label: $data['target_step_label'] ?? null,
            uuid: $data['uuid'] ?? null,
        );
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'target_step_label' => $this->target_step_label,
            'uuid' => $this->uuid,
        ];
    }
    ...
    public function with(mixed ...$fields): self
    {
        return new self(
            ...
            target_step_label: array_key_exists('target_step_label', $fields) ? $fields['target_step_label'] : $this->target_step_label,
