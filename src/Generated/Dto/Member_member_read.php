...
final class Member_member_read
{
    public function __construct(
        public readonly ?string $audience = null,
        public readonly ?string $client_ip = null,
        public readonly ?\DateTimeImmutable $created_at = null,
        /** @var list<CustomField_member_read>|null */
        ...
        /** @var list<Group_member_read>|null */
        public readonly ?array $groups = null,
        public readonly ?int $id = null,
        public readonly ?string $iri = null,
        public readonly ?string $last_name = null,
        public readonly ?string $locale = null,
        public readonly ?Location_member_read $location = null,
        public readonly ?MemberConsent_member_read $member_consent = null,
        ...
        public readonly ?MemberStatsResource_member_read $stats = null,
        public readonly ?\Easymailing\Sdk\Generated\Enum\SuscriberStatus $status = null,
        public readonly ?SuscriptionForm_member_read $suscription_form = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            custom_fields: isset($data['custom_fields']) ? array_map(fn($x) => CustomField_member_read::fromArray($x), $data['custom_fields']) : null,
            ...
            groups: isset($data['groups']) ? array_map(fn($x) => Group_member_read::fromArray($x), $data['groups']) : null,
            id: $data['id'] ?? null,
            iri: $data['iri'] ?? null,
            last_name: $data['last_name'] ?? null,
            locale: $data['locale'] ?? null,
            location: isset($data['location']) ? Location_member_read::fromArray($data['location']) : null,
            member_consent: isset($data['member_consent']) ? MemberConsent_member_read::fromArray($data['member_consent']) : null,
            ...
            stats: isset($data['stats']) ? MemberStatsResource_member_read::fromArray($data['stats']) : null,
            status: isset($data['status']) ? \Easymailing\Sdk\Generated\Enum\SuscriberStatus::from($data['status']) : null,
            suscription_form: isset($data['suscription_form']) ? SuscriptionForm_member_read::fromArray($data['suscription_form']) : null,
