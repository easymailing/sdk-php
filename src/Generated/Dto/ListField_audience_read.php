...
final class ListField_audience_read
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            iri: $data['iri'] ?? null,
            list_field_options: isset($data['list_field_options']) ? array_map(fn($x) => ListFieldOption_audience_read::fromArray($x), $data['list_field_options']) : null,
            options: $data['options'] ?? null,
            public: $data['public'] ?? null,
            required: $data['required'] ?? null,
            tag: $data['tag'] ?? null,
            template_tag: $data['template_tag'] ?? null,
            translations: isset($data['translations']) ? array_map(fn($x) => ListFieldTranslation_audience_read::fromArray($x), $data['translations']) : null,
