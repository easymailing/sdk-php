...
final class Member_jsonld_automation_queue_read
{
    public function __construct(
        ...
        public readonly ?MemberConsent_jsonld_automation_queue_read $member_consent = null,
        public readonly ?float $rating = null,
        public readonly ?\Easymailing\Sdk\Generated\Enum\SuscriberSource $source = null,
        public readonly ?MemberStatsResource_jsonld_automation_queue_read $stats = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            custom_fields: isset($data['custom_fields']) ? array_map(fn($x) => CustomField_jsonld_automation_queue_read::fromArray($x), $data['custom_fields']) : null,
            ...
            groups: isset($data['groups']) ? array_map(fn($x) => Group_jsonld_automation_queue_read::fromArray($x), $data['groups']) : null,
            locale: $data['locale'] ?? null,
            location: isset($data['location']) ? Location_jsonld_automation_queue_read::fromArray($data['location']) : null,
            member_consent: isset($data['member_consent']) ? MemberConsent_jsonld_automation_queue_read::fromArray($data['member_consent']) : null,
            rating: $data['rating'] ?? null,
            source: isset($data['source']) ? \Easymailing\Sdk\Generated\Enum\SuscriberSource::from($data['source']) : null,
            stats: isset($data['stats']) ? MemberStatsResource_jsonld_automation_queue_read::fromArray($data['stats']) : null,
