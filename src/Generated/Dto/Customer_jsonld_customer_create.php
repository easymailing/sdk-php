...
final class Customer_jsonld_customer_create
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            custom_fields: isset($data['custom_fields']) ? array_map(fn($x) => CustomField_jsonld_customer_create::fromArray($x), $data['custom_fields']) : null,
