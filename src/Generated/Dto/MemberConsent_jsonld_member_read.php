...
final class MemberConsent_jsonld_member_read
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            ip: $data['ip'] ?? null,
            treatment_purposes: isset($data['treatment_purposes']) ? array_map(fn($x) => TreatmentPurpose_jsonld_member_read::fromArray($x), $data['treatment_purposes']) : null,
        );
    }
