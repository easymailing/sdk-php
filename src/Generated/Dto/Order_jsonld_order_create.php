...
final class Order_jsonld_order_create
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            order_items: isset($data['order_items']) ? array_map(fn($x) => OrderItem_jsonld_order_create::fromArray($x), $data['order_items']) : null,
