...
final class CustomField_member_read
{
    public function __construct(
        public readonly ?ListField_member_read $list_field,
    ...
    {
        return new self(
            list_field: isset($data['list_field']) ? ListField_member_read::fromArray($data['list_field']) : null,
            iri: $data['iri'] ?? null,
            uuid: $data['uuid'] ?? null,
