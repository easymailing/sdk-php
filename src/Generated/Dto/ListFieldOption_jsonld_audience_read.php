...
final class ListFieldOption_jsonld_audience_read
{
    public function __construct(
        public readonly ?string $iri = null,
        /** @var list<ListFieldOptionTranslation_jsonld_audience_read>|null */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            iri: $data['iri'] ?? null,
            translations: isset($data['translations']) ? array_map(fn($x) => ListFieldOptionTranslation_jsonld_audience_read::fromArray($x), $data['translations']) : null,
            uuid: $data['uuid'] ?? null,
