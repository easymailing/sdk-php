...
final class AutomationStep_AutomationStepUpdateCustomField_automation_step_write
{
    public function __construct(
        public readonly ?UpdateCustomFieldAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? UpdateCustomFieldAction_automation_step_write::fromArray($data['action']) : null,
