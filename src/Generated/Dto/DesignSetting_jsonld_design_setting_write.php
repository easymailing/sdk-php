...
final class DesignSetting_jsonld_design_setting_write
{
    public function __construct(
        ...
        /** @var CustomFontDto_jsonld_design_setting_write[]|null */
        ...
        /** @var SocialLinkDto_jsonld_design_setting_write[]|null */
        public readonly ?array $social_links = null,
        public readonly ?TextsDto_jsonld_design_setting_write $texts = null,
        public readonly ?TitlesDto_jsonld_design_setting_write $titles = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            title: $data['title'],
            button: isset($data['button']) ? ButtonDto_jsonld_design_setting_write::fromArray($data['button']) : null,
            color_palette: $data['color_palette'] ?? null,
            custom_fonts: isset($data['custom_fonts']) ? array_map(fn($x) => CustomFontDto_jsonld_design_setting_write::fromArray($x), $data['custom_fonts']) : null,
            default: $data['default'] ?? null,
            email_width: $data['email_width'] ?? null,
            page_width: $data['page_width'] ?? null,
            social_links: isset($data['social_links']) ? array_map(fn($x) => SocialLinkDto_jsonld_design_setting_write::fromArray($x), $data['social_links']) : null,
            texts: isset($data['texts']) ? TextsDto_jsonld_design_setting_write::fromArray($data['texts']) : null,
            titles: isset($data['titles']) ? TitlesDto_jsonld_design_setting_write::fromArray($data['titles']) : null,
        );
    }
