...
final class AutomationStep_AutomationStepUpdateScoreResource_automation_step_read
{
    public function __construct(
        public readonly ?UpdateScoreAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? UpdateScoreAction_automation_step_read::fromArray($data['action']) : null,
