...
final class TreatmentPurpose_jsonld_automation_queue_read
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            translations: isset($data['translations']) ? array_map(fn($x) => TreatmentPurposeTranslation_jsonld_automation_queue_read::fromArray($x), $data['translations']) : null,
        );
    }
