...
final class AutomationStep_AutomationStepUpdateScoreResource_jsonld_automation_step_read
{
    public function __construct(
        ...
        public readonly ?UpdateScoreAction_jsonld_automation_step_read $action = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            action: isset($data['action']) ? UpdateScoreAction_jsonld_automation_step_read::fromArray($data['action']) : null,
