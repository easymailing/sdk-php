...
final class Order_order_import
{
    public function __construct(
        ...
        /** @var list<OrderItem_order_import>|null */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            order_items: isset($data['order_items']) ? array_map(fn($x) => OrderItem_order_import::fromArray($x), $data['order_items']) : null,
