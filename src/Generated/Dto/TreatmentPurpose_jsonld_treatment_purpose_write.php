...
final class TreatmentPurpose_jsonld_treatment_purpose_write
{
    public function __construct(
        ...
        /** @var list<TreatmentPurposeTranslation_jsonld_treatment_purpose_write>|null */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            name: $data['name'] ?? null,
            translations: isset($data['translations']) ? array_map(fn($x) => TreatmentPurposeTranslation_jsonld_treatment_purpose_write::fromArray($x), $data['translations']) : null,
        );
    }
