...
final class Campaign_CampaignTestABSenderInput_campaign_write_test_ab_sender
{
    public function __construct(
        public readonly string $audience,
        public readonly ?CampaignConfig_campaign_write_test_ab_sender $campaign_config,
        public readonly string $delay_unit,
        public readonly int $delay_value,
        public readonly ?EmailConfig_campaign_write_test_ab_sender $email_config,
        public readonly string $send_to,
        public readonly int $test_size,
        public readonly string $title,
        /** @var list<SenderVariantInput_campaign_write_test_ab_sender> */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            campaign_config: isset($data['campaign_config']) ? CampaignConfig_campaign_write_test_ab_sender::fromArray($data['campaign_config']) : null,
            delay_unit: $data['delay_unit'],
            delay_value: $data['delay_value'],
            email_config: isset($data['email_config']) ? EmailConfig_campaign_write_test_ab_sender::fromArray($data['email_config']) : null,
            send_to: $data['send_to'],
            test_size: $data['test_size'],
            title: $data['title'],
            variants: array_map(fn($x) => SenderVariantInput_campaign_write_test_ab_sender::fromArray($x), $data['variants']),
