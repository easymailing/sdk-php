...
final class AutomationStep_AutomationStepSendCampaignResource_automation_step_read
{
    public function __construct(
        public readonly ?SendCampaignAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendCampaignAction_automation_step_read::fromArray($data['action']) : null,
