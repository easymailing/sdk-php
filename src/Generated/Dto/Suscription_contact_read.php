...
final class Suscription_contact_read
{
    public function __construct(
        ...
        public readonly ?SuscriberConsent_contact_read $suscriber_consent = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            custom_fields: isset($data['custom_fields']) ? array_map(fn($x) => CustomField_contact_read::fromArray($x), $data['custom_fields']) : null,
            groups: isset($data['groups']) ? array_map(fn($x) => Group_contact_read::fromArray($x), $data['groups']) : null,
            iri: $data['iri'] ?? null,
            ...
            suscriber_consent: isset($data['suscriber_consent']) ? SuscriberConsent_contact_read::fromArray($data['suscriber_consent']) : null,
