...
final class AutomationStep_AutomationStepSendNotificationResource_automation_step_read
{
    public function __construct(
        public readonly ?SendNotificationAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendNotificationAction_automation_step_read::fromArray($data['action']) : null,
