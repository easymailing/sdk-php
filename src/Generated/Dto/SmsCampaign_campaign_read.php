...
final class SmsCampaign_campaign_read
{
    public function __construct(
        ...
        public readonly ?SmsCampaignConfigResource_campaign_read $sms_campaign_config = null,
        public readonly ?SmsCampaignStatsResource_campaign_read $sms_campaign_stats = null,
        public readonly ?SmsConfigResource_campaign_read $sms_config = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            sms_campaign_config: isset($data['sms_campaign_config']) ? SmsCampaignConfigResource_campaign_read::fromArray($data['sms_campaign_config']) : null,
            sms_campaign_stats: isset($data['sms_campaign_stats']) ? SmsCampaignStatsResource_campaign_read::fromArray($data['sms_campaign_stats']) : null,
            sms_config: isset($data['sms_config']) ? SmsConfigResource_campaign_read::fromArray($data['sms_config']) : null,
