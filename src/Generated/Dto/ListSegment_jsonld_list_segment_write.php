...
final class ListSegment_jsonld_list_segment_write
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            conditions: isset($data['conditions']) ? array_map(fn($x) => ListSegmentCondition_jsonld_list_segment_write::fromArray($x), $data['conditions']) : null,
