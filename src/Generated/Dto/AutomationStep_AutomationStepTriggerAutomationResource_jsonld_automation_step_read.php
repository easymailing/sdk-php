...
final class AutomationStep_AutomationStepTriggerAutomationResource_jsonld_automation_step_read
{
    public function __construct(
        ...
        public readonly ?TriggerAutomationAction_jsonld_automation_step_read $action = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            action: isset($data['action']) ? TriggerAutomationAction_jsonld_automation_step_read::fromArray($data['action']) : null,
