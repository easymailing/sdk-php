...
final class AutomationStep_AutomationStepSendWebhookResource_jsonld_automation_step_read
{
    public function __construct(
        ...
        public readonly ?SendWebhookAction_jsonld_automation_step_read $action = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            action: isset($data['action']) ? SendWebhookAction_jsonld_automation_step_read::fromArray($data['action']) : null,
