...
final class ListField_CustomFieldMultiselect_list_field_write
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            tag: $data['tag'],
            translations: array_map(fn($x) => CustomFieldTranslationInput_list_field_write::fromArray($x), $data['translations']),
