...
final class AutomationStep_AutomationStepTriggerAutomationResource_automation_step_read
{
    public function __construct(
        public readonly ?TriggerAutomationAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? TriggerAutomationAction_automation_step_read::fromArray($data['action']) : null,
