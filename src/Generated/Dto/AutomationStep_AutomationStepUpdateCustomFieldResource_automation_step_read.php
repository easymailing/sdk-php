...
final class AutomationStep_AutomationStepUpdateCustomFieldResource_automation_step_read
{
    public function __construct(
        public readonly ?UpdateCustomFieldAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? UpdateCustomFieldAction_automation_step_read::fromArray($data['action']) : null,
