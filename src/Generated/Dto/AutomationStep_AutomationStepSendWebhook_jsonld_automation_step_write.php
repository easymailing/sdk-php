...
final class AutomationStep_AutomationStepSendWebhook_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?SendWebhookAction_jsonld_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendWebhookAction_jsonld_automation_step_write::fromArray($data['action']) : null,
