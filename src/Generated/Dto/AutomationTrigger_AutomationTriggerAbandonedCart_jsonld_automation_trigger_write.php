...
final class AutomationTrigger_AutomationTriggerAbandonedCart_jsonld_automation_trigger_write
{
    public function __construct(
        ...
        /** @var list<Category_jsonld_automation_trigger_write>|null */
        public readonly ?array $categories = null,
        public readonly ?bool $exclude = null,
        /** @var list<Product_jsonld_automation_trigger_write>|null */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            store: $data['store'],
            categories: isset($data['categories']) ? array_map(fn($x) => Category_jsonld_automation_trigger_write::fromArray($x), $data['categories']) : null,
            exclude: $data['exclude'] ?? null,
            products: isset($data['products']) ? array_map(fn($x) => Product_jsonld_automation_trigger_write::fromArray($x), $data['products']) : null,
