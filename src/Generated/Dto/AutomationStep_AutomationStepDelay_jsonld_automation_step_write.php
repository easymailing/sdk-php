...
final class AutomationStep_AutomationStepDelay_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?DelayAction_jsonld_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? DelayAction_jsonld_automation_step_write::fromArray($data['action']) : null,
