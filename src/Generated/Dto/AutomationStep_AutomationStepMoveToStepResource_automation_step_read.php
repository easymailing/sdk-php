...
final class AutomationStep_AutomationStepMoveToStepResource_automation_step_read
{
    public function __construct(
        public readonly ?MoveToStepAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? MoveToStepAction_automation_step_read::fromArray($data['action']) : null,
