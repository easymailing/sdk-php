...
final class AutomationStep_AutomationStepCondition_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?ConditionAction_jsonld_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? ConditionAction_jsonld_automation_step_write::fromArray($data['action']) : null,
