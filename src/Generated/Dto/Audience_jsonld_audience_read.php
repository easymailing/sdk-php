...
final class Audience_jsonld_audience_read
{
    public function __construct(
        public readonly string $currency,
        public readonly string $description,
        public readonly ?ListGdpr_jsonld_audience_read $list_gdpr,
        public readonly ?AudiencePreferencesDto_jsonld_audience_read $preferences,
        ...
        public readonly ?AudienceResourcesDto_jsonld_audience_read $audience_resources = null,
        public readonly ?AudienceStatsDto_jsonld_audience_read $audience_stats = null,
        public readonly ?AudienceCompanyDto_jsonld_audience_read $company = null,
        public readonly ?\DateTimeImmutable $created_at = null,
        /** @var list<Group_jsonld_audience_read>|null */
        public readonly ?array $groups = null,
        public readonly ?int $id = null,
        /** @var list<ListField_jsonld_audience_read>|null */
        public readonly ?array $list_fields = null,
        /** @var list<ListSegment_jsonld_audience_read>|null */
        public readonly ?array $list_segments = null,
        public readonly ?AudienceNotificationsDto_jsonld_audience_read $notifications = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            list_gdpr: isset($data['list_gdpr']) ? ListGdpr_jsonld_audience_read::fromArray($data['list_gdpr']) : null,
            preferences: isset($data['preferences']) ? AudiencePreferencesDto_jsonld_audience_read::fromArray($data['preferences']) : null,
            ...
            audience_resources: isset($data['audience_resources']) ? AudienceResourcesDto_jsonld_audience_read::fromArray($data['audience_resources']) : null,
            audience_stats: isset($data['audience_stats']) ? AudienceStatsDto_jsonld_audience_read::fromArray($data['audience_stats']) : null,
            company: isset($data['company']) ? AudienceCompanyDto_jsonld_audience_read::fromArray($data['company']) : null,
            created_at: isset($data['created_at']) ? new \DateTimeImmutable($data['created_at']) : null,
            groups: isset($data['groups']) ? array_map(fn($x) => Group_jsonld_audience_read::fromArray($x), $data['groups']) : null,
            id: $data['id'] ?? null,
            list_fields: isset($data['list_fields']) ? array_map(fn($x) => ListField_jsonld_audience_read::fromArray($x), $data['list_fields']) : null,
            list_segments: isset($data['list_segments']) ? array_map(fn($x) => ListSegment_jsonld_audience_read::fromArray($x), $data['list_segments']) : null,
            notifications: isset($data['notifications']) ? AudienceNotificationsDto_jsonld_audience_read::fromArray($data['notifications']) : null,
