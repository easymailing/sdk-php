...
final class AutomationStep_AutomationStepSendNotificationResource_jsonld_automation_step_read
{
    public function __construct(
        ...
        public readonly ?SendNotificationAction_jsonld_automation_step_read $action = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            action: isset($data['action']) ? SendNotificationAction_jsonld_automation_step_read::fromArray($data['action']) : null,
