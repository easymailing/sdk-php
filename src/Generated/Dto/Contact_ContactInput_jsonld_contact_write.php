...
final class Contact_ContactInput_jsonld_contact_write
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            consent: isset($data['consent']) ? SuscriberConsent_jsonld_contact_write::fromArray($data['consent']) : null,
            custom_fields: isset($data['custom_fields']) ? array_map(fn($x) => CustomField_jsonld_contact_write::fromArray($x), $data['custom_fields']) : null,
            ...
            groups: isset($data['groups']) ? array_map(fn($x) => Group_jsonld_contact_write::fromArray($x), $data['groups']) : null,
