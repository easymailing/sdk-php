...
final class Contact_contact_read
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            location: isset($data['location']) ? Location_contact_read::fromArray($data['location']) : null,
            phone: $data['phone'] ?? null,
            suscriptions: isset($data['suscriptions']) ? array_map(fn($x) => Suscription_contact_read::fromArray($x), $data['suscriptions']) : null,
