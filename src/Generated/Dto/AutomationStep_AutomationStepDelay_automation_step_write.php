...
final class AutomationStep_AutomationStepDelay_automation_step_write
{
    public function __construct(
        public readonly ?DelayAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? DelayAction_automation_step_write::fromArray($data['action']) : null,
