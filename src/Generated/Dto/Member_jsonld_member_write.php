...
final class Member_jsonld_member_write
{
    public function __construct(
        public readonly ?string $client_ip = null,
        /** @var list<CustomField_jsonld_member_write>|null */
        ...
        public readonly ?Location_jsonld_member_write $location = null,
        public readonly ?MemberConsent_jsonld_member_write $member_consent = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            custom_fields: isset($data['custom_fields']) ? array_map(fn($x) => CustomField_jsonld_member_write::fromArray($x), $data['custom_fields']) : null,
            email: $data['email'] ?? null,
            first_name: $data['first_name'] ?? null,
            groups: $data['groups'] ?? null,
            last_name: $data['last_name'] ?? null,
            locale: $data['locale'] ?? null,
            location: isset($data['location']) ? Location_jsonld_member_write::fromArray($data['location']) : null,
            member_consent: isset($data['member_consent']) ? MemberConsent_jsonld_member_write::fromArray($data['member_consent']) : null,
