...
final class AutomationStep_AutomationStepSendCampaign_automation_step_write
{
    public function __construct(
        public readonly ?SendCampaignAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendCampaignAction_automation_step_write::fromArray($data['action']) : null,
