...
final class Campaign_jsonld_campaign_read
{
    public function __construct(
        ...
        public readonly ?CampaignStat_jsonld_campaign_read $campaign_stats = null,
        ...
        public readonly ?CampaignTestConfigResource_jsonld_campaign_read $test_config = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            campaign_stats: isset($data['campaign_stats']) ? CampaignStat_jsonld_campaign_read::fromArray($data['campaign_stats']) : null,
            channel: $data['channel'] ?? null,
            created_at: isset($data['created_at']) ? new \DateTimeImmutable($data['created_at']) : null,
            email_config: isset($data['email_config']) ? EmailConfig_jsonld_campaign_read::fromArray($data['email_config']) : null,
            ...
            test_config: isset($data['test_config']) ? CampaignTestConfigResource_jsonld_campaign_read::fromArray($data['test_config']) : null,
            title: $data['title'] ?? null,
            type: isset($data['type']) ? \Easymailing\Sdk\Generated\Enum\CampaignType::from($data['type']) : null,
            updated_at: isset($data['updated_at']) ? new \DateTimeImmutable($data['updated_at']) : null,
            uuid: $data['uuid'] ?? null,
            variants: isset($data['variants']) ? array_map(fn($x) => CampaignTestVariantResource_jsonld_campaign_read::fromArray($x), $data['variants']) : null,
        );
    }
