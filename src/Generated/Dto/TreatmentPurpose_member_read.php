...
final class TreatmentPurpose_member_read
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            translations: isset($data['translations']) ? array_map(fn($x) => TreatmentPurposeTranslation_member_read::fromArray($x), $data['translations']) : null,
        );
    }
