...
final class AutomationStep_AutomationStepSendSmsResource_jsonld_automation_step_read
{
    public function __construct(
        public readonly ?SendSmsAction_jsonld_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendSmsAction_jsonld_automation_step_read::fromArray($data['action']) : null,
