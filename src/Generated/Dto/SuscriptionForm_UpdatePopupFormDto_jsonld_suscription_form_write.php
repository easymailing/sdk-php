...
final class SuscriptionForm_UpdatePopupFormDto_jsonld_suscription_form_write
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            locale: $data['locale'],
            title: $data['title'],
            behavior: isset($data['behavior']) ? PopupBehaviorDto_jsonld_suscription_form_write::fromArray($data['behavior']) : null,
            channels: $data['channels'] ?? null,
            double_opt_in: $data['double_opt_in'] ?? null,
            enable_welcome_email: $data['enable_welcome_email'] ?? null,
            groups: isset($data['groups']) ? array_map(fn($x) => Group_jsonld_suscription_form_write::fromArray($x), $data['groups']) : null,
