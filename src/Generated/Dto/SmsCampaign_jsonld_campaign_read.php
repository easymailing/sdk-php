...
final class SmsCampaign_jsonld_campaign_read
{
    public function __construct(
        ...
        public readonly ?SmsCampaignStatsResource_jsonld_campaign_read $sms_campaign_stats = null,
        public readonly ?SmsConfigResource_jsonld_campaign_read $sms_config = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            sms_campaign_stats: isset($data['sms_campaign_stats']) ? SmsCampaignStatsResource_jsonld_campaign_read::fromArray($data['sms_campaign_stats']) : null,
            sms_config: isset($data['sms_config']) ? SmsConfigResource_jsonld_campaign_read::fromArray($data['sms_config']) : null,
