...
final class AutomationStep_AutomationStepUpdateScore_automation_step_write
{
    public function __construct(
        public readonly ?UpdateScoreAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? UpdateScoreAction_automation_step_write::fromArray($data['action']) : null,
