...
final class AutomationStep_AutomationStepPosition_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?bool $first = null,
    ...
    {
        return new self(
            first: array_key_exists('first', $fields) ? $fields['first'] : $this->first,
