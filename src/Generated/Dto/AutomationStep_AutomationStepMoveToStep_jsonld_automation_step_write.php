...
final class AutomationStep_AutomationStepMoveToStep_jsonld_automation_step_write
{
    public function __construct(
        public readonly ?MoveToStepAction_jsonld_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? MoveToStepAction_jsonld_automation_step_write::fromArray($data['action']) : null,
