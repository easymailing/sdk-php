...
final class Automation_automation_read_automation_read_detail
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            automation_triggers: isset($data['automation_triggers']) ? array_map(fn($x) => AutomationTrigger_automation_read_automation_read_detail::fromArray($x), $data['automation_triggers']) : null,
            created_at: isset($data['created_at']) ? new \DateTimeImmutable($data['created_at']) : null,
            description: $data['description'] ?? null,
            first_step: isset($data['first_step']) ? AutomationStep_automation_read_automation_read_detail::fromArray($data['first_step']) : null,
            id: $data['id'] ?? null,
            orphan_steps: isset($data['orphan_steps']) ? array_map(fn($x) => AutomationStep_automation_read_automation_read_detail::fromArray($x), $data['orphan_steps']) : null,
            stats: isset($data['stats']) ? AutomationMetric_automation_read_automation_read_detail::fromArray($data['stats']) : null,
