...
final class AutomationStep_AutomationStepSendNotification_automation_step_write
{
    public function __construct(
        public readonly ?SendNotificationAction_automation_step_write $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendNotificationAction_automation_step_write::fromArray($data['action']) : null,
