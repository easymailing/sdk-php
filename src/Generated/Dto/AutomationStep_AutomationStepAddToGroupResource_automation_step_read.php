...
final class AutomationStep_AutomationStepAddToGroupResource_automation_step_read
{
    public function __construct(
        public readonly ?AddToGroupAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? AddToGroupAction_automation_step_read::fromArray($data['action']) : null,
