...
final class SmsCampaign_CampaignSmsInput_campaign_write_sms
{
    public function __construct(
        public readonly string $audience,
        public readonly string $send_to,
        public readonly ?SmsConfigResource_campaign_write_sms $sms_config,
        public readonly string $title,
        /** @var list<string>|null */
        public readonly ?array $groups = null,
        public readonly ?string $list_segment = null,
        public readonly ?SmsCampaignConfigResource_campaign_write_sms $sms_campaign_config = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            sms_config: isset($data['sms_config']) ? SmsConfigResource_campaign_write_sms::fromArray($data['sms_config']) : null,
            title: $data['title'],
            groups: $data['groups'] ?? null,
            list_segment: $data['list_segment'] ?? null,
            sms_campaign_config: isset($data['sms_campaign_config']) ? SmsCampaignConfigResource_campaign_write_sms::fromArray($data['sms_campaign_config']) : null,
        );
    }
