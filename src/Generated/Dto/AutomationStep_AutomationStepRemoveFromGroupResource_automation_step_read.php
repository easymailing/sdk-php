...
final class AutomationStep_AutomationStepRemoveFromGroupResource_automation_step_read
{
    public function __construct(
        public readonly ?RemoveFromGroupAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? RemoveFromGroupAction_automation_step_read::fromArray($data['action']) : null,
