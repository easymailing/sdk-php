...
final class AutomationStep_AutomationStepSendWebhookResource_automation_step_read
{
    public function __construct(
        public readonly ?SendWebhookAction_automation_step_read $action = null,
    ...
    {
        return new self(
            action: isset($data['action']) ? SendWebhookAction_automation_step_read::fromArray($data['action']) : null,
