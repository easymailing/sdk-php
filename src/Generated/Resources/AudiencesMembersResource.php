...
final class AudiencesMembersResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/members', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null]), query: $query);
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Member_member_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Member_member_read::fromArray($data);
    }
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
    }

    public function addToGroup(string $uuid, string $groupUuid): \Easymailing\Sdk\Generated\Dto\Member_member_read
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}/actions/add_to_group/{groupUuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid, 'groupUuid' => $groupUuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Member_member_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}/actions/remove_from_group/{groupUuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid, 'groupUuid' => $groupUuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Member_member_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}/actions/subscribe', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Member_member_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/members/{uuid}/actions/unsubscribe', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Member_member_read::fromArray($data);
    }
