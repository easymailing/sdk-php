...
final class StoresCustomersResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/stores/{storeResourceId}/customers', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null]), query: $query, pathTemplate: '/stores/{storeResourceId}/customers');
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/stores/{storeResourceId}/customers/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), pathTemplate: '/stores/{storeResourceId}/customers/{resourceId}');
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Customer_customer_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/customers/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray(), pathTemplate: '/stores/{storeResourceId}/customers/{resourceId}');
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Customer_customer_read::fromArray($data);
    }
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/stores/{storeResourceId}/customers/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), query: array_filter(['unsubscribe' => $unsubscribe], static fn($value): bool => $value !== null), pathTemplate: '/stores/{storeResourceId}/customers/{resourceId}');
    }
