...
final class StoresCategoriesResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/stores/{storeResourceId}/categories', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null]), query: $query);
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/stores/{storeResourceId}/categories', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null]), body: is_array($body) ? $body : $body->toArray());
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/stores/{storeResourceId}/categories/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Category_category_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/categories/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Category_category_read::fromArray($data);
    }
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/stores/{storeResourceId}/categories/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]));
    }
