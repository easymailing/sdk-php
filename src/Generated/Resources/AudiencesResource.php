...
final class AudiencesResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences', []), query: $query, pathTemplate: '/audiences');
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences', []), body: is_array($body) ? $body : $body->toArray(), pathTemplate: '/audiences');
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{uuid}', ['uuid' => $uuid]), pathTemplate: '/audiences/{uuid}');
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Audience_audience_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{uuid}', ['uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray(), pathTemplate: '/audiences/{uuid}');
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Audience_audience_read::fromArray($data);
    }
