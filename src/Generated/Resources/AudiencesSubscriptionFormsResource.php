...
final class AudiencesSubscriptionFormsResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null]), query: $query);
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
    }

    public function pause(string $uuid): \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/actions/pause', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/actions/publish', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/actions/resume', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/actions/unpublish', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/embedded', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/popup', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/publishing_info', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/embedded', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/suscription_forms/{uuid}/popup', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\SuscriptionForm_suscription_form_read::fromArray($data);
    }
