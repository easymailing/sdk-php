...
final class StoresOrdersResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/stores/{storeResourceId}/orders', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null]), query: $query);
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/stores/{storeResourceId}/orders', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null]), body: is_array($body) ? $body : $body->toArray());
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Order_order_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Order_order_read::fromArray($data);
    }
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]));
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}/actions/cancel_order', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/stores/{storeResourceId}/orders/import', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Order_order_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}/actions/pay_order', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\OrderResource_order_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}/actions/process_order', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\OrderResource_order_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}/actions/refund_order', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\OrderResource_order_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/stores/{storeResourceId}/orders/{resourceId}/actions/ship_order', ['storeResourceId' => $this->boundParams['storeResourceId'] ?? null, 'resourceId' => $resourceId]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\OrderResource_order_read::fromArray($data);
    }
