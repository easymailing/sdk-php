...
final class AudiencesListSegmentsResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/list_segments', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null]), query: $query);
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/list_segments', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null]), body: is_array($body) ? $body : $body->toArray());
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\ListSegment_list_segment_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\ListSegment_list_segment_read::fromArray($data);
    }
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
    }

    public function addToGroup(string $uuid): \Easymailing\Sdk\Generated\Dto\ListSegment_AsyncTaskResource
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}/actions/add_to_group', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}/actions/delete_contacts', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\ListSegment_AsyncTaskResource::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}/actions/export', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\ListSegment_AsyncTaskResource::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}/actions/remove_from_group', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\ListSegment_AsyncTaskResource::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/audiences/{audienceUuid}/list_segments/{uuid}/actions/unsubscribe', ['audienceUuid' => $this->boundParams['audienceUuid'] ?? null, 'uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\ListSegment_AsyncTaskResource::fromArray($data);
    }
