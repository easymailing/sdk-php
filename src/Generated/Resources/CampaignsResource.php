...
final class CampaignsResource extends AbstractResource
{
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/campaigns', []), query: $query);
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/campaigns', []), body: is_array($body) ? $body : $body->toArray());
    ...
    {
        $result = $this->client->request('GET', $this->resolvePath('/campaigns/{uuid}', ['uuid' => $uuid]));
        $data = is_array($result['data']) ? $result['data'] : [];
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/campaigns/{uuid}', ['uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Campaign_campaign_read::fromArray($data);
    }
    ...
    {
        $this->client->request('DELETE', $this->resolvePath('/campaigns/{uuid}', ['uuid' => $uuid]));
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/campaigns/{uuid}/actions/duplicate', ['uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Campaign_campaign_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/campaigns/{uuid}/actions/schedule', ['uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return $data;
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/campaigns/{uuid}/actions/send_now', ['uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return $data;
    }
    ...
    {
        $result = $this->client->request('PUT', $this->resolvePath('/campaigns/{uuid}/actions/send_test', ['uuid' => $uuid]), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return $data;
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/campaigns/revalidation', []), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Campaign_campaign_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/campaigns/test_ab/sender', []), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Campaign_campaign_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/campaigns/test_ab/subject', []), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Campaign_campaign_read::fromArray($data);
    }
    ...
    {
        $result = $this->client->request('POST', $this->resolvePath('/campaigns/test_ab/template', []), body: is_array($body) ? $body : $body->toArray());
        $data = is_array($result['data']) ? $result['data'] : [];
        return \Easymailing\Sdk\Generated\Dto\Campaign_campaign_read::fromArray($data);
    }
